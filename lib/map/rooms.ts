...
export const ROOMS: RoomDef[] = [
  ...
  { id: 'president',   entityId: 'president',    name: '사장실',     emoji: '🏛️', description: '대표님(이정우) 전용 집무실. 자비스 컴퍼니 최종 의사결정권자. CEO 보고서 수신·경영 방향 결정·전략 승인이 이루어지는 공간입니다.',                                                     x: 29, y: 2,  w: 7, h: 5, type: 'meeting', npcX: 32, npcY: 4,  teamColor: '#f59e0b', floorStyle: 'executive' },
  // Row 2 (y=10)
